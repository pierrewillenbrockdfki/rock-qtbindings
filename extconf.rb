...
File.open('Makefile', 'w') do |file|
  if windows
    ...
    file.puts "\t-copy ext\\build\\smoke\\deptool\\smoke5deptool.exe bin\\#{ruby_version}"
    ...
    file.puts "\t-copy ext\\build\\smoke\\smokeapi\\smoke5api.exe bin\\#{ruby_version}"
    file.puts "\t-copy ext\\build\\smoke\\smokebase\\libsmokebase.dll lib\\#{ruby_version}"
    file.puts "\t-copy ext\\build\\ruby\\qtruby\\src\\libqtruby5shared.dll lib\\#{ruby_version}"
    file.puts "\t-copy ext\\build\\ruby\\qtdeclarative\\qtdeclarative5.dll lib\\#{ruby_version}\\qtdeclarative5.so"
    file.puts "\t-copy ext\\build\\ruby\\qtruby\\src\\qtruby5.dll lib\\#{ruby_version}\\qtruby5.so"
    file.puts "\t-copy ext\\build\\ruby\\qtscript\\qtscript5.dll lib\\#{ruby_version}\\qtscript5.so"
    file.puts "\t-copy ext\\build\\ruby\\qttest\\qttest5.dll lib\\#{ruby_version}\\qttest5.so"
    file.puts "\t-copy ext\\build\\ruby\\qtuitools\\qtuitools5.dll lib\\#{ruby_version}\\qtuitools5.so"
    file.puts "\t-copy ext\\build\\ruby\\qtwebkit\\qtwebkit5.dll lib\\#{ruby_version}\\qtwebkit5.so"
    ...
    file.puts "install: build"
    if macosx
      file.puts "\t-cp ext/build/smoke/smokeapi/smoke5api bin/#{ruby_version}"
      file.puts "\t-cp ext/build/smoke/deptool/smoke5deptool bin/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtdeclarative/qtdeclarative5.so lib/#{ruby_version}/qtdeclarative5.bundle"
      file.puts "\t-cp ext/build/ruby/qtruby/src/qtruby5.so lib/#{ruby_version}/qtruby5.bundle"
      file.puts "\t-cp ext/build/ruby/qtscript/qtscript5.* lib/#{ruby_version}/qtscript5.bundle"
      file.puts "\t-cp ext/build/ruby/qttest/qttest5.* lib/#{ruby_version}/qttest5.bundle"
      file.puts "\t-cp ext/build/ruby/qtuitools/qtuitools5.* lib/#{ruby_version}/qtuitools5.bundle"
      file.puts "\t-cp ext/build/ruby/qtwebkit/qtwebkit5.* lib/#{ruby_version}/qtwebkit5.bundle"
      ...
      file.puts "\t-cp ext/build/ruby/qtdeclarative/qtdeclarative5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtruby/src/libqtruby5shared.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtruby/src/qtruby5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtscript/qtscript5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qttest/qttest5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtuitools/qtuitools5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtwebkit/qtwebkit5.* lib/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtruby/tools/rbrcc/rbrcc5 bin/#{ruby_version}"
      file.puts "\t-cp ext/build/ruby/qtruby/tools/rbuic/rbuic5 bin/#{ruby_version}"
    end
  end
