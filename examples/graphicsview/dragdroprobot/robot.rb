...
class RobotPart < Qt5::GraphicsItem
    
    def initialize(parent)
        super(parent)
        @color = Qt5::Color.new(Qt5::lightGray)
    ...
    def dropEvent(event)
        @dragOver = false
        if event.mimeData.hasColor
            @color = qVariantValue(Qt5::Color, event.mimeData.colorData)
        elsif event.mimeData.hasImage
            @pixmap = qVariantValue(Qt5::Pixmap, event.mimeData.imageData)
        end
        update()
    end
end
...
class RobotHead < RobotPart
    Type = Qt5::GraphicsItem::UserType + 1
    ...
    def boundingRect
        return Qt5::RectF.new(-15, -50, 30, 50)
    end
    
    def paint(painter, option, widget)
        if @pixmap.null?
            painter.brush = Qt5::Brush.new(@dragOver ? @color.light(130) : @color)
            ...
            painter.pen = Qt5::Pen.new(Qt5::Brush.new(Qt5::black), 2)
            painter.brush = Qt5::NoBrush
            painter.drawArc(-6, -2 - 20, 12, 15, 190 * 16, 160 * 16)
        else
            painter.scale(0.2272, 0.2824)
            painter.drawPixmap(Qt5::PointF.new(-15 * 4.4, -50 * 3.54), @pixmap)
        end
    end
...
class RobotTorso < RobotPart
    ...
    def boundingRect
        return Qt5::RectF.new(-30, -20, 60, 60)
    end
...
class RobotLimb < RobotPart
    ...
    def boundingRect
        return Qt5::RectF.new(-5, -5, 40, 10)
    end
...
class Robot < RobotPart
    ...
    def initialize(view)
        ...
        @timeLine = Qt5::TimeLine.new
    
        headAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
            a.item = headItem
            a.timeLine = @timeLine
        ...
        upperLeftArmAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        lowerLeftArmAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        upperRightArmAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        lowerRightArmAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        upperLeftLegAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        lowerLeftLegAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        upperRightLegAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        lowerRightLegAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
        ...
        torsoAnimation = Qt5::GraphicsItemAnimation.new(view) do |a|
            a.item = torsoItem
            a.timeLine = @timeLine
            a.setRotationAt(0, 5)
            a.setRotationAt(1, -20)
        ...
        @timeLine.curveShape = Qt5::TimeLine::SineCurve
